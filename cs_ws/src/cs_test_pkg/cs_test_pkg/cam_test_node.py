...
class CamTestNode(Node):
    ...
    def __init__(self):
        ...
        self.img = numpy.zeros([2000,2000,3])

        self.img[:,:,0] = numpy.ones([2000,2000])*0
        self.img[:,:,1] = numpy.ones([2000,2000])*0
        self.img[:,:,2] = numpy.ones([2000,2000])*0
    ...
    def timer_callback(self):
        ...
        self.img[self.i%200, math.floor(self.i/200)] = 255
