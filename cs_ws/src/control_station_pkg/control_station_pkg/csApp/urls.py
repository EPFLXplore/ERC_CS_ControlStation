...
urlpatterns = [
    ...
    path('actions/cancelAllGoal', cancel_all_actions, name='cancel_all_goal'),
    path('actions/cancelAction', cancel_action, name='cancel_action'),
    path('actions/startAction', start_action, name='start_action')
