...
class CS:
    ...
    def __init__(self):
       ...
       # self.node.create_subscription(Int8,             'ROVER/TaskProgress',              self.controller.task_progress      , 10)
        ...
        #Camera messages
        self.node.create_subscription(CompressedImage,            '/camera_1',                 cameras_reciever.display_cam_0   , 1)
        self.node.create_subscription(CompressedImage,            '/camera_2',                 cameras_reciever.display_cam_1   , 1)
