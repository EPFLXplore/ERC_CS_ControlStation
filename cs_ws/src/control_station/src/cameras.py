...
CAMERA1_WS_URL = 'ws://127.0.0.1:8000/ws/cameras/video/'
CAMERA2_WS_URL = 'ws://127.0.0.1:8000/ws/cameras/video2/'
CAMERA3_WS_URL = 'ws://127.0.0.1:8000/ws/cameras/video3/'
...
def display_cam_2(msg):
    ...
    # result, imgencode = cv2.imencode('.jpg', im2, encode_param)
    # data = np.array(imgencode)
    # img = data.tobytes()
