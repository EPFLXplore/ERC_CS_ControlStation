...
class CS:
    ...
    def __init__(self):
        ...
        # SC messages
        rospy.Subscriber('ROVER_SC_state',                 String,          self.controller.sc_text_info       ) #self.sc_state
        ...
        # NAV messages
        rospy.Subscriber('/cmd_vel',           Twist,    self.controller.test_joystick) # TODO i forgot why we subcribed to this...
