...
from std_msgs.msg import Int8, Int16, Int32, Bool, String, Int8MultiArray, Int16MultiArray, Float32MultiArray, \
    UInt8MultiArray
    ...
    def task_instr(self, array):
        ...
        # NAVIGATION
            ...
            if (instr == Instruction.LAUNCH.value):
                ...
                self.Nav_Goal_pub.publish(PoseStamped(self.model.Nav.getGoal()))
            # ABORT
