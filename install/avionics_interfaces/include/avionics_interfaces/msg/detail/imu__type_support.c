...
#include <stddef.h>
#include "avionics_interfaces/msg/detail/imu__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  avionics_interfaces__msg__Imu__init(message_memory);
}

void Imu__rosidl_typesupport_introspection_c__Imu_fini_function(void * message_memory)
{
  avionics_interfaces__msg__Imu__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Imu__rosidl_typesupport_introspection_c__Imu_message_member_array[2] = {
  {
    ...
    offsetof(avionics_interfaces__msg__Imu, id),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(avionics_interfaces__msg__Imu, imu),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Imu__rosidl_typesupport_introspection_c__Imu_message_members = {
  ...
  "Imu",  // message name
  2,  // number of fields
  sizeof(avionics_interfaces__msg__Imu),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, avionics_interfaces, msg, Imu)() {
