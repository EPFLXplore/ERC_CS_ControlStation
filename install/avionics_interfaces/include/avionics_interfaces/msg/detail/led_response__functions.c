...
avionics_interfaces__msg__LEDResponse__create()
{
  ...
  avionics_interfaces__msg__LEDResponse * msg = (avionics_interfaces__msg__LEDResponse *)allocator.allocate(sizeof(avionics_interfaces__msg__LEDResponse), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(avionics_interfaces__msg__LEDResponse));
  bool success = avionics_interfaces__msg__LEDResponse__init(msg);
  if (!success) {
...
avionics_interfaces__msg__LEDResponse__destroy(avionics_interfaces__msg__LEDResponse * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    avionics_interfaces__msg__LEDResponse__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
avionics_interfaces__msg__LEDResponse__Sequence__init(avionics_interfaces__msg__LEDResponse__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  avionics_interfaces__msg__LEDResponse * data = NULL;

  if (size) {
    data = (avionics_interfaces__msg__LEDResponse *)allocator.zero_allocate(size, sizeof(avionics_interfaces__msg__LEDResponse), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = avionics_interfaces__msg__LEDResponse__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        avionics_interfaces__msg__LEDResponse__fini(&data[i - 1]);
      }
...
avionics_interfaces__msg__LEDResponse__Sequence__fini(avionics_interfaces__msg__LEDResponse__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      avionics_interfaces__msg__LEDResponse__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  avionics_interfaces__msg__LEDResponse__Sequence * array = (avionics_interfaces__msg__LEDResponse__Sequence *)allocator.allocate(sizeof(avionics_interfaces__msg__LEDResponse__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = avionics_interfaces__msg__LEDResponse__Sequence__init(array, size);
  if (!success) {
...
avionics_interfaces__msg__LEDResponse__Sequence__destroy(avionics_interfaces__msg__LEDResponse__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    avionics_interfaces__msg__LEDResponse__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
avionics_interfaces__msg__LEDResponse__Sequence__are_equal(const avionics_interfaces__msg__LEDResponse__Sequence * lhs, const avionics_interfaces__msg__LEDResponse__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!avionics_interfaces__msg__LEDResponse__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  avionics_interfaces__msg__LEDResponse__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(avionics_interfaces__msg__LEDResponse);
    avionics_interfaces__msg__LEDResponse * data =
      (avionics_interfaces__msg__LEDResponse *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!avionics_interfaces__msg__LEDResponse__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          avionics_interfaces__msg__LEDResponse__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!avionics_interfaces__msg__LEDResponse__copy(
