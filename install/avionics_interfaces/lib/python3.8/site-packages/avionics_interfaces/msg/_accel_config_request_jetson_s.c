...
bool avionics_interfaces__msg__accel_config_request_jetson__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("avionics_interfaces.msg._accel_config_request_jetson.AccelConfigRequestJetson", full_classname_dest, 77) == 0);
  }
  avionics_interfaces__msg__AccelConfigRequestJetson * ros_message = _ros_message;
  {  // destination_id
...
{
  /* NOTE(esteve): Call constructor of AccelConfigRequestJetson */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("avionics_interfaces.msg._accel_config_request_jetson");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AccelConfigRequestJetson");
