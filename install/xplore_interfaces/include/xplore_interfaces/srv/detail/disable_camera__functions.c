...
xplore_interfaces__srv__DisableCamera_Request__create()
{
  ...
  xplore_interfaces__srv__DisableCamera_Request * msg = (xplore_interfaces__srv__DisableCamera_Request *)allocator.allocate(sizeof(xplore_interfaces__srv__DisableCamera_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(xplore_interfaces__srv__DisableCamera_Request));
  bool success = xplore_interfaces__srv__DisableCamera_Request__init(msg);
  if (!success) {
...
xplore_interfaces__srv__DisableCamera_Request__destroy(xplore_interfaces__srv__DisableCamera_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    xplore_interfaces__srv__DisableCamera_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
xplore_interfaces__srv__DisableCamera_Request__Sequence__init(xplore_interfaces__srv__DisableCamera_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xplore_interfaces__srv__DisableCamera_Request * data = NULL;

  if (size) {
    data = (xplore_interfaces__srv__DisableCamera_Request *)allocator.zero_allocate(size, sizeof(xplore_interfaces__srv__DisableCamera_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = xplore_interfaces__srv__DisableCamera_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        xplore_interfaces__srv__DisableCamera_Request__fini(&data[i - 1]);
      }
...
xplore_interfaces__srv__DisableCamera_Request__Sequence__fini(xplore_interfaces__srv__DisableCamera_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      xplore_interfaces__srv__DisableCamera_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xplore_interfaces__srv__DisableCamera_Request__Sequence * array = (xplore_interfaces__srv__DisableCamera_Request__Sequence *)allocator.allocate(sizeof(xplore_interfaces__srv__DisableCamera_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = xplore_interfaces__srv__DisableCamera_Request__Sequence__init(array, size);
  if (!success) {
...
xplore_interfaces__srv__DisableCamera_Request__Sequence__destroy(xplore_interfaces__srv__DisableCamera_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    xplore_interfaces__srv__DisableCamera_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
xplore_interfaces__srv__DisableCamera_Request__Sequence__are_equal(const xplore_interfaces__srv__DisableCamera_Request__Sequence * lhs, const xplore_interfaces__srv__DisableCamera_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!xplore_interfaces__srv__DisableCamera_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  xplore_interfaces__srv__DisableCamera_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(xplore_interfaces__srv__DisableCamera_Request);
    xplore_interfaces__srv__DisableCamera_Request * data =
      (xplore_interfaces__srv__DisableCamera_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!xplore_interfaces__srv__DisableCamera_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          xplore_interfaces__srv__DisableCamera_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!xplore_interfaces__srv__DisableCamera_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xplore_interfaces__srv__DisableCamera_Response * msg = (xplore_interfaces__srv__DisableCamera_Response *)allocator.allocate(sizeof(xplore_interfaces__srv__DisableCamera_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(xplore_interfaces__srv__DisableCamera_Response));
  bool success = xplore_interfaces__srv__DisableCamera_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
xplore_interfaces__srv__DisableCamera_Response__destroy(xplore_interfaces__srv__DisableCamera_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    xplore_interfaces__srv__DisableCamera_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
xplore_interfaces__srv__DisableCamera_Response__Sequence__init(xplore_interfaces__srv__DisableCamera_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xplore_interfaces__srv__DisableCamera_Response * data = NULL;

  if (size) {
    data = (xplore_interfaces__srv__DisableCamera_Response *)allocator.zero_allocate(size, sizeof(xplore_interfaces__srv__DisableCamera_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = xplore_interfaces__srv__DisableCamera_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        xplore_interfaces__srv__DisableCamera_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
xplore_interfaces__srv__DisableCamera_Response__Sequence__fini(xplore_interfaces__srv__DisableCamera_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      xplore_interfaces__srv__DisableCamera_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xplore_interfaces__srv__DisableCamera_Response__Sequence * array = (xplore_interfaces__srv__DisableCamera_Response__Sequence *)allocator.allocate(sizeof(xplore_interfaces__srv__DisableCamera_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = xplore_interfaces__srv__DisableCamera_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
xplore_interfaces__srv__DisableCamera_Response__Sequence__destroy(xplore_interfaces__srv__DisableCamera_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    xplore_interfaces__srv__DisableCamera_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
xplore_interfaces__srv__DisableCamera_Response__Sequence__are_equal(const xplore_interfaces__srv__DisableCamera_Response__Sequence * lhs, const xplore_interfaces__srv__DisableCamera_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!xplore_interfaces__srv__DisableCamera_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  xplore_interfaces__srv__DisableCamera_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(xplore_interfaces__srv__DisableCamera_Response);
    xplore_interfaces__srv__DisableCamera_Response * data =
      (xplore_interfaces__srv__DisableCamera_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!xplore_interfaces__srv__DisableCamera_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          xplore_interfaces__srv__DisableCamera_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!xplore_interfaces__srv__DisableCamera_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
