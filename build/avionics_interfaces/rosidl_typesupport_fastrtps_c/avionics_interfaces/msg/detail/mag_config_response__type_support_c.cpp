...
#include "avionics_interfaces/msg/detail/mag_config_response__rosidl_typesupport_fastrtps_c.h"
...
using _MagConfigResponse__ros_msg_type = avionics_interfaces__msg__MagConfigResponse;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _MagConfigResponse__ros_msg_type * ros_message = static_cast<const _MagConfigResponse__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    cdr << ros_message->id;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _MagConfigResponse__ros_msg_type * ros_message = static_cast<_MagConfigResponse__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    cdr >> ros_message->id;
  }
...
size_t get_serialized_size_avionics_interfaces__msg__MagConfigResponse(
  const void * untyped_ros_message,
...
static uint32_t _MagConfigResponse__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_avionics_interfaces__msg__MagConfigResponse(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_avionics_interfaces
size_t max_serialized_size_avionics_interfaces__msg__MagConfigResponse(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_avionics_interfaces__msg__MagConfigResponse(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_MagConfigResponse = {
...
static rosidl_message_type_support_t _MagConfigResponse__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_MagConfigResponse,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, avionics_interfaces, msg, MagConfigResponse)() {
  return &_MagConfigResponse__type_support;
}
