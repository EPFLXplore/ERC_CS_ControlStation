...
#include "avionics_interfaces/msg/detail/pot_config_response__rosidl_typesupport_fastrtps_c.h"
...
using _PotConfigResponse__ros_msg_type = avionics_interfaces__msg__PotConfigResponse;

static bool _PotConfigResponse__cdr_serialize(
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _PotConfigResponse__ros_msg_type * ros_message = static_cast<const _PotConfigResponse__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    cdr << ros_message->id;
  }
...
static bool _PotConfigResponse__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _PotConfigResponse__ros_msg_type * ros_message = static_cast<_PotConfigResponse__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    cdr >> ros_message->id;
  }
...
size_t get_serialized_size_avionics_interfaces__msg__PotConfigResponse(
  const void * untyped_ros_message,
...
static uint32_t _PotConfigResponse__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_avionics_interfaces__msg__PotConfigResponse(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_avionics_interfaces
size_t max_serialized_size_avionics_interfaces__msg__PotConfigResponse(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _PotConfigResponse__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_avionics_interfaces__msg__PotConfigResponse(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_PotConfigResponse = {
  "avionics_interfaces::msg",
  "PotConfigResponse",
  _PotConfigResponse__cdr_serialize,
  _PotConfigResponse__cdr_deserialize,
  _PotConfigResponse__get_serialized_size,
  _PotConfigResponse__max_serialized_size
};

static rosidl_message_type_support_t _PotConfigResponse__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_PotConfigResponse,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, avionics_interfaces, msg, PotConfigResponse)() {
  return &_PotConfigResponse__type_support;
}
