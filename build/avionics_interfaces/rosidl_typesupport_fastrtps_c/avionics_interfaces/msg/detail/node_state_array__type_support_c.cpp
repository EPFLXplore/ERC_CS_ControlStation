...
#include "avionics_interfaces/msg/detail/node_state_array__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // node_state
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // node_state

// forward declare type support functions


using _NodeStateArray__ros_msg_type = avionics_interfaces__msg__NodeStateArray;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: node_state
  {
    ...
    auto array_ptr = ros_message->node_state.data;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: node_state
  {
    ...
    if (ros_message->node_state.data) {
      rosidl_runtime_c__boolean__Sequence__fini(&ros_message->node_state);
    }
    if (!rosidl_runtime_c__boolean__Sequence__init(&ros_message->node_state, size)) {
      return "failed to create array for field 'node_state'";
    }
    auto array_ptr = ros_message->node_state.data;
...
size_t get_serialized_size_avionics_interfaces__msg__NodeStateArray(
  const void * untyped_ros_message,
...
static uint32_t _NodeStateArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_avionics_interfaces__msg__NodeStateArray(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_avionics_interfaces
size_t max_serialized_size_avionics_interfaces__msg__NodeStateArray(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_avionics_interfaces__msg__NodeStateArray(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, avionics_interfaces, msg, NodeStateArray)() {
