...
avionics_interfaces__msg__NodeStateArray__init(avionics_interfaces__msg__NodeStateArray * msg)
{
  ...
  // node_state
  if (!rosidl_runtime_c__boolean__Sequence__init(&msg->node_state, 0)) {
    avionics_interfaces__msg__NodeStateArray__fini(msg);
    return false;
  }
  return true;
}
...
avionics_interfaces__msg__NodeStateArray__fini(avionics_interfaces__msg__NodeStateArray * msg)
{
  ...
  // node_state
  rosidl_runtime_c__boolean__Sequence__fini(&msg->node_state);
}
  ...
  avionics_interfaces__msg__NodeStateArray * output)
{
  ...
  if (!rosidl_runtime_c__boolean__Sequence__copy(
      &(input->node_state), &(output->node_state)))
  {
    return false;
  }
  return true;
...
avionics_interfaces__msg__NodeStateArray__create()
{
  ...
  avionics_interfaces__msg__NodeStateArray * msg = (avionics_interfaces__msg__NodeStateArray *)allocator.allocate(sizeof(avionics_interfaces__msg__NodeStateArray), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(avionics_interfaces__msg__NodeStateArray));
  bool success = avionics_interfaces__msg__NodeStateArray__init(msg);
  if (!success) {
...
avionics_interfaces__msg__NodeStateArray__Sequence__init(avionics_interfaces__msg__NodeStateArray__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  avionics_interfaces__msg__NodeStateArray * data = NULL;

  if (size) {
    data = (avionics_interfaces__msg__NodeStateArray *)allocator.zero_allocate(size, sizeof(avionics_interfaces__msg__NodeStateArray), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = avionics_interfaces__msg__NodeStateArray__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        avionics_interfaces__msg__NodeStateArray__fini(&data[i - 1]);
      }
...
avionics_interfaces__msg__NodeStateArray__Sequence__fini(avionics_interfaces__msg__NodeStateArray__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      avionics_interfaces__msg__NodeStateArray__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  avionics_interfaces__msg__NodeStateArray__Sequence * array = (avionics_interfaces__msg__NodeStateArray__Sequence *)allocator.allocate(sizeof(avionics_interfaces__msg__NodeStateArray__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = avionics_interfaces__msg__NodeStateArray__Sequence__init(array, size);
  if (!success) {
...
avionics_interfaces__msg__NodeStateArray__Sequence__destroy(avionics_interfaces__msg__NodeStateArray__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    avionics_interfaces__msg__NodeStateArray__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
avionics_interfaces__msg__NodeStateArray__Sequence__are_equal(const avionics_interfaces__msg__NodeStateArray__Sequence * lhs, const avionics_interfaces__msg__NodeStateArray__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!avionics_interfaces__msg__NodeStateArray__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  avionics_interfaces__msg__NodeStateArray__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(avionics_interfaces__msg__NodeStateArray);
    avionics_interfaces__msg__NodeStateArray * data =
      (avionics_interfaces__msg__NodeStateArray *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!avionics_interfaces__msg__NodeStateArray__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          avionics_interfaces__msg__NodeStateArray__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!avionics_interfaces__msg__NodeStateArray__copy(
