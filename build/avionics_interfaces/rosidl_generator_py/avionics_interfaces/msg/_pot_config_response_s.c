...
bool avionics_interfaces__msg__pot_config_response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("avionics_interfaces.msg._pot_config_response.PotConfigResponse", full_classname_dest, 62) == 0);
  }
  avionics_interfaces__msg__PotConfigResponse * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of PotConfigResponse */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("avionics_interfaces.msg._pot_config_response");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PotConfigResponse");
