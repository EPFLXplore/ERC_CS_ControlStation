...
bool avionics_interfaces__msg__servo_request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("avionics_interfaces.msg._servo_request.ServoRequest", full_classname_dest, 51) == 0);
  }
  avionics_interfaces__msg__ServoRequest * ros_message = _ros_message;
  {  // destination_id
...
{
  /* NOTE(esteve): Call constructor of ServoRequest */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("avionics_interfaces.msg._servo_request");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ServoRequest");
