...
bool avionics_interfaces__msg__servo_config_response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("avionics_interfaces.msg._servo_config_response.ServoConfigResponse", full_classname_dest, 66) == 0);
  }
  avionics_interfaces__msg__ServoConfigResponse * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of ServoConfigResponse */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("avionics_interfaces.msg._servo_config_response");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ServoConfigResponse");
