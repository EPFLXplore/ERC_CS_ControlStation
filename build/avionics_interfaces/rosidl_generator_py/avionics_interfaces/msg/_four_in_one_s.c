...
bool avionics_interfaces__msg__four_in_one__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("avionics_interfaces.msg._four_in_one.FourInOne", full_classname_dest, 46) == 0);
  }
  avionics_interfaces__msg__FourInOne * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of FourInOne */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("avionics_interfaces.msg._four_in_one");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FourInOne");
