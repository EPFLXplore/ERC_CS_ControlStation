...
bool avionics_interfaces__msg__mag_config_request_jetson__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("avionics_interfaces.msg._mag_config_request_jetson.MagConfigRequestJetson", full_classname_dest, 73) == 0);
  }
  avionics_interfaces__msg__MagConfigRequestJetson * ros_message = _ros_message;
  {  // destination_id
...
{
  /* NOTE(esteve): Call constructor of MagConfigRequestJetson */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("avionics_interfaces.msg._mag_config_request_jetson");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MagConfigRequestJetson");
