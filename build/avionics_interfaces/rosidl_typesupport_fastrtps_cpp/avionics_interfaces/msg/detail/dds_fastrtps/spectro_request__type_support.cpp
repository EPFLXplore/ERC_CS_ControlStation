...
#include "avionics_interfaces/msg/detail/spectro_request__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const avionics_interfaces::msg::SpectroRequest & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  avionics_interfaces::msg::SpectroRequest & ros_message)
{
  // Member: destination_id
  cdr >> ros_message.destination_id;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_avionics_interfaces
max_serialized_size_SpectroRequest(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const avionics_interfaces::msg::SpectroRequest *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<avionics_interfaces::msg::SpectroRequest *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SpectroRequest__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const avionics_interfaces::msg::SpectroRequest *>(
...
{
  return max_serialized_size_SpectroRequest(full_bounded, 0);
}

static message_type_support_callbacks_t _SpectroRequest__callbacks = {
...
static rosidl_message_type_support_t _SpectroRequest__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SpectroRequest__callbacks,
...
{
  return &avionics_interfaces::msg::typesupport_fastrtps_cpp::_SpectroRequest__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, avionics_interfaces, msg, SpectroRequest)() {
  return &avionics_interfaces::msg::typesupport_fastrtps_cpp::_SpectroRequest__handle;
}
