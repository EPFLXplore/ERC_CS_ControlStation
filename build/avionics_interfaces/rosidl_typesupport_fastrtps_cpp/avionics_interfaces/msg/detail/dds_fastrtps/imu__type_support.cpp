...
#include "avionics_interfaces/msg/detail/imu__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const avionics_interfaces::msg::Imu *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<avionics_interfaces::msg::Imu *>(
    untyped_ros_message);
...
{
  return &avionics_interfaces::msg::typesupport_fastrtps_cpp::_Imu__handle;
}
