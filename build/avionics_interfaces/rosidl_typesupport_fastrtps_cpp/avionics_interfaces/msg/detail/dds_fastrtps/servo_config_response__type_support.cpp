...
#include "avionics_interfaces/msg/detail/servo_config_response__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const avionics_interfaces::msg::ServoConfigResponse & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  avionics_interfaces::msg::ServoConfigResponse & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_avionics_interfaces
max_serialized_size_ServoConfigResponse(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const avionics_interfaces::msg::ServoConfigResponse *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<avionics_interfaces::msg::ServoConfigResponse *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ServoConfigResponse__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const avionics_interfaces::msg::ServoConfigResponse *>(
...
{
  return max_serialized_size_ServoConfigResponse(full_bounded, 0);
}

static message_type_support_callbacks_t _ServoConfigResponse__callbacks = {
...
static rosidl_message_type_support_t _ServoConfigResponse__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ServoConfigResponse__callbacks,
...
{
  return &avionics_interfaces::msg::typesupport_fastrtps_cpp::_ServoConfigResponse__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, avionics_interfaces, msg, ServoConfigResponse)() {
  return &avionics_interfaces::msg::typesupport_fastrtps_cpp::_ServoConfigResponse__handle;
}
