...
static const _PotConfigRequestJetson_type_support_symbol_names_t _PotConfigRequestJetson_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, avionics_interfaces, msg, PotConfigRequestJetson)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, avionics_interfaces, msg, PotConfigRequestJetson)),
  }
};
...
{
  return &::avionics_interfaces::msg::rosidl_typesupport_cpp::PotConfigRequestJetson_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, avionics_interfaces, msg, PotConfigRequestJetson)() {
  return get_message_type_support_handle<avionics_interfaces::msg::PotConfigRequestJetson>();
}
