...
static const _PotConfigRequestMCU_type_support_symbol_names_t _PotConfigRequestMCU_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, avionics_interfaces, msg, PotConfigRequestMCU)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, avionics_interfaces, msg, PotConfigRequestMCU)),
  }
};
...
{
  return &::avionics_interfaces::msg::rosidl_typesupport_cpp::PotConfigRequestMCU_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, avionics_interfaces, msg, PotConfigRequestMCU)() {
  return get_message_type_support_handle<avionics_interfaces::msg::PotConfigRequestMCU>();
}
