...
{
  new (message_memory) avionics_interfaces::msg::Imu(_init);
}

void Imu_fini_function(void * message_memory)
{
  auto typed_message = static_cast<avionics_interfaces::msg::Imu *>(message_memory);
  typed_message->~Imu();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Imu_message_member_array[2] = {
  {
    ...
    offsetof(avionics_interfaces::msg::Imu, id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(avionics_interfaces::msg::Imu, imu),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Imu_message_members = {
  ...
  "Imu",  // message name
  2,  // number of fields
  sizeof(avionics_interfaces::msg::Imu),
...
get_message_type_support_handle<avionics_interfaces::msg::Imu>()
{
  return &::avionics_interfaces::msg::rosidl_typesupport_introspection_cpp::Imu_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, avionics_interfaces, msg, Imu)() {
  return &::avionics_interfaces::msg::rosidl_typesupport_introspection_cpp::Imu_message_type_support_handle;
}
