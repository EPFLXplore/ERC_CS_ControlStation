...
static const _MassConfigRequestJetson_type_support_symbol_names_t _MassConfigRequestJetson_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, avionics_interfaces, msg, MassConfigRequestJetson)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, avionics_interfaces, msg, MassConfigRequestJetson)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, avionics_interfaces, msg, MassConfigRequestJetson)() {
  return &::avionics_interfaces::msg::rosidl_typesupport_c::MassConfigRequestJetson_message_type_support_handle;
}
