...
static const _MagConfigRequestMCU_type_support_symbol_names_t _MagConfigRequestMCU_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, avionics_interfaces, msg, MagConfigRequestMCU)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, avionics_interfaces, msg, MagConfigRequestMCU)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, avionics_interfaces, msg, MagConfigRequestMCU)() {
  return &::avionics_interfaces::msg::rosidl_typesupport_c::MagConfigRequestMCU_message_type_support_handle;
}
