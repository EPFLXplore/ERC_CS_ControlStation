...
class App(Gtk.Application):
  ...
  def do_startup(self):
    ...
    rospy.Subscriber('adc',             Float32MultiArray, Controller.callback_gripper)
    rospy.Subscriber('mass',            Float32,           Controller.callback_measures)

    ##Power suplly avionics commands
    rospy.Publisher('reset_power',      Bool,              Controller.callback_reset_power)
    rospy.Publisher('switch_power',     Bool,              Controller.callback_switch_power)
    rospy.Publisher('switch_raman',     Bool,              Controller.callback_switch_raman)
    rospy.Publisher('switch_jetson',    Bool,              Controller.callback_switch_jetson)
    rospy.Publisher('switch_LIDAR',     Bool,              Controller.callback_switch_LIDAR)
    rospy.Publisher('switch_ethernet',  Bool,              Controller.callback_switch_ethernet)
